...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-07-2018 a las 17:58:00
...
--
-- Estructura de tabla para la tabla `afirmacion`
--

CREATE TABLE `afirmacion` (
  `id_afirm` int(3) NOT NULL,
  `text_afirm` int(15) NOT NULL
...
CREATE TABLE `conectores` (
  `id_conec` int(3) NOT NULL,
  `text_conec` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `conectores` (`id_conec`, `text_conec`) VALUES
(1, 'Que'),
(2, 'Cual'),
(3, 'Cuales'),
(4, 'Cuanto');
...
CREATE TABLE `p` (
  `id_palabra` int(1) NOT NULL,
  `text_palab` int(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pal_area`
--

CREATE TABLE `pal_area` (
  `id_palabra` int(3) NOT NULL,
  `text_palab` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `pal_area`
--

INSERT INTO `pal_area` (`id_palabra`, `text_palab`) VALUES
(1, 'Pelicula'),
(2, 'Peliculas'),
(3, 'Combos'),
(4, 'contiene'),
...
--
-- Indices de la tabla `afirmacion`
--
ALTER TABLE `afirmacion`
  ADD PRIMARY KEY (`id_afirm`);
...
--
-- Indices de la tabla `pal_area`
--
ALTER TABLE `pal_area`
...
--
-- AUTO_INCREMENT de la tabla `afirmacion`
--
ALTER TABLE `afirmacion`
  MODIFY `id_afirm` int(3) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `conectores`
  MODIFY `id_conec` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT de la tabla `pal_area`
--
ALTER TABLE `pal_area`
  MODIFY `id_palabra` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `saludo`
  MODIFY `id_saludo` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
